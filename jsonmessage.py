				...
				for i in things:
					...
					if i in message or (int(additions) == 1 and int(deletions) ==1):
						...
						if answer == 'y':
							...
							data = {"Commit Mistakes" : CommitMistakes, "Commit Corrections" : CommitCorrections, "Mistake:" : mistake, "Tags" : tag, "Length": length, "Keyword:" : i, "Additions": additions, "Deletions:": deletions, "Changes:" : patch}
							entries.append(data)
