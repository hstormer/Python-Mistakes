# Use this file to collect data about commits with and without mistakes. Pymongo must be installed, and there must be a mongo database of commits from github to look through.
